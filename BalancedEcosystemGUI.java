...
class BalancedEcosystemGUI extends JFrame implements ActionListener, ChangeListener, MouseListener
{
    ...
    class BtnListener implements ActionListener // Button menu
    {
        public void actionPerformed (ActionEvent e)
        {
            ...
            {
                preyEnergySl.setValue(100);
                predatorHungerSl.setValue(20);
                predatorFoodRequiredSl.setValue(500);
                predatorRepCoolDownSl.setValue(500);
            ...
            else if(e.getSource() == wolfBtn)
            {
                ...
                predatorFoodRequiredSl.setValue(50);
                predatorRepCoolDownSl.setValue(40);
            ...
            { 
                preyEnergySl.setValue(5);
                predatorHungerSl.setValue(100);
                predatorFoodRequiredSl.setValue(100);
                predatorRepCoolDownSl.setValue(100);
